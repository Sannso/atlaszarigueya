...
<div class="subcontent-buttons mb-8">
    <div class="flex flex-wrap gap-3 justify-center">
        ...
        <div class="card-content">
          <div class="card-header">
            ...
            <div class="organ-info">
              <h3 class="organ-title">Abdomen</h3>
              <span class="system-tag">Sistema Cavidades</span>
            </div>
          </div>
          <p class="organ-description">Cavidad abdominal y órganos digestivos</p>
      ...
      <a href="/atlas/es/cavidades/oral-nasal" class="organ-card">
        <div class="card-content">
          <div class="card-header">
            <div class="organ-icon">
              <div class="organ-placeholder">
            ...
            <div class="organ-info">
              <h3 class="organ-title">Oral/Nasal</h3>
              <span class="system-tag">Sistema Cavidades</span>
            </div>
          </div>
          <p class="organ-description">Cavidades oral y nasal</p>
          <div class="card-footer">
            <span class="view-more">Ver más</span>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14M12 5l7 7-7 7" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
          </div>
      ...
      <a href="/atlas/es/cavidades/torax" class="organ-card">
        <div class="card-content">
          <div class="card-header">
            <div class="organ-icon">
              <div class="organ-placeholder">
            ...
            <div class="organ-info">
              <h3 class="organ-title">Tórax</h3>
              <span class="system-tag">Sistema Cavidades</span>
            </div>
          </div>
          <p class="organ-description">Cavidad torácica y órganos respiratorios</p>
          <div class="card-footer">
            <span class="view-more">Ver más</span>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5 12h14M12 5l7 7-7 7" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
          </div>
