...
lang: es
order: 32
description: Estructura y función de los linfonodos en la zarigüeya.
tags: [linfatico, linfonodos]
---

<a href="/atlas/es/sistemas/sistema-linfatico/intro" class="back-button absolute top-6 left-0 inline-flex items-center text-gray-600 hover:text-gray-900 transition-colors bg-white/80 backdrop-blur-sm px-3 py-2 rounded-lg shadow-sm">
...
Los linfonodos son pequeñas estructuras ovaladas que funcionan como filtros del sistema linfático, donde se activan las respuestas inmunes y se filtra la linfa para eliminar patógenos y células anormales.

### Estructura y función ganglionar

Los linfonodos de la zarigüeya presentan una estructura típica con corteza y médula bien diferenciadas, conteniendo folículos linfoides donde maduran los linfocitos B y zonas paracorticales donde se localizan los linfocitos T.

<div class="image-gallery mb-12">
  <h3 class="gallery-title text-2xl font-bold mb-6 text-center">Linfonodos Normales</h3>
  <div class="gallery-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    <div class="col-span-full text-center py-12 bg-gray-50 rounded-xl">
      <div class="text-gray-500 text-lg font-medium">
        ...
        No hay imágenes normales disponibles para linfonodos
      </div>
    </div>
  </div>
</div>

## Patologías/lesiones de los Linfonodos
    ...
    <div class="image-card group cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-xl rounded-xl">
      <div class="relative overflow-hidden rounded-xl bg-gradient-to-br from-violet-50 to-indigo-100 p-4">
        <div class="aspect-square mb-3 bg-white rounded-xl shadow-inner flex items-center justify-center overflow-hidden min-h-[250px]">
          <img src="/images/atlas/sistemas/sistema-linfatico/linfonodos/patologia/14.png" 
               alt="Linfadenopatía reactiva" 
               class="w-full h-full object-cover rounded-xl transition-transform duration-500 group-hover:scale-110"
               loading="lazy">
        </div>
        <h4 class="font-semibold text-gray-800 mb-2">Linfadenopatía reactiva</h4>
        <p class="text-sm text-gray-600 line-clamp-2 h-10">Hay presencia de linfonodo mesentérico aumentado de tamaño a lo largo del intestino delgad</p>
